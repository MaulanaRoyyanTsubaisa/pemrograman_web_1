                ...
                data.forEach((item, index) => {
                    html += `
                        <tr>
                            ...
                            <td class="align-middle">${item.nama_matkul}</td>
                            <td class="align-middle">${item.waktu}</td>
...
function siapkanTambah() {
    document.getElementById('modalTitle').innerText = 'Tambah Jadwal Kuliah';
    document.getElementById('formEntity').reset();
    document.getElementById('id').value = '';
}

function siapkanEdit(id) {
    document.getElementById('modalTitle').innerText = 'Ubah Jadwal Kuliah';
    document.getElementById('formEntity').reset();
